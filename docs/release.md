...
The mechanical steps are scripted. You still own the changelog prose and the version number. The two
irreversible actions, pushing the tag and publishing to the registries, never run without you
asking.
