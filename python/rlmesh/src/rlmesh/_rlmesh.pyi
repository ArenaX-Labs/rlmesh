...
class EnvContract:
    ...
    @property
    def observation_space(self) -> SpaceSpec | None: ...
    @property
    def action_space(self) -> SpaceSpec | None: ...
...
class Space:
    ...
    def seed(self, seed: typing.Optional[builtins.int]) -> typing.Optional[builtins.int]: ...
