...
class ModelIOSpec:
    ...
    @classmethod
    def from_dict(cls, data: Mapping[str, Any]) -> ModelIOSpec:
    ...
    @classmethod
    def from_json(cls, payload: str) -> ModelIOSpec:
        """Build a spec from :meth:`to_json` output."""
        return cls.from_dict(load_json_mapping(payload))

    @classmethod
    def from_metadata(cls, metadata: Mapping[str, Any]) -> ModelIOSpec | None:
