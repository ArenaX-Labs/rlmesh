...
fn model_predict_request_bytes_are_frozen() {
    assert_frozen(
        ...
        &[
            ...
            101, 113, 45, 49, 18, 9, 10, 3, 1, 2, 3, 10, 2, 4, 5, 34, 8, 10, 4, 101, 112, 45, 49,
            16, 7, 34, 6, 10, 4, 101, 112, 45, 50,
        ],
    );
}
...
fn model_join_request_bytes_are_frozen() {
    ...
    assert_frozen(
        ...
        message.encode_to_vec(),
        &[
            18, 53, 10, 22, 10, 6, 115, 101, 115, 115, 45, 49, 18, 5, 101, 110, 118, 45, 49, 26, 5,
            114, 101, 113, 45, 49, 18, 9, 10, 3, 1, 2, 3, 10, 2, 4, 5, 34, 8, 10, 4, 101, 112, 45,
            49, 16, 7, 34, 6, 10, 4, 101, 112, 45, 50, 42, 5, 114, 101, 113, 45, 49,
        ],
    );
}
