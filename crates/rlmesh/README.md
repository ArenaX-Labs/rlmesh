...
- The scalar `Env` trait and explicit `VectorEnv` trait for environment bindings.
- `EnvServer` / `RemoteEnv` and `VectorEnvServer` / `RemoteVectorEnv` for serving and connecting to environments.
