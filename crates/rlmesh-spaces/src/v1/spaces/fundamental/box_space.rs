...
use crate::v1::DType;
use crate::v1::spaces::{SpaceSpec, space_spec};
use crate::v1::{AxiswiseBounds, BoxSpec, ElementwiseBounds, UniformBounds, box_spec};
...
impl BoxSpaceBuilder {
    ...
    pub fn build(self) -> Result<SpaceSpec, SpaceError> {
        ...
        crate::v1::spaces::validate_space(&spec)?;
        Ok(spec)
    }
}
